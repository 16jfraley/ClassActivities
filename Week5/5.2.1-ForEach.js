...
data.forEach((element) => console.log(element.address.city) )

// create an array of latitude and longitude coordinate pairs
let array = [];
data.forEach((arr) => array.push(arr.address.geo,arr.address.geo))
console.log(array)

// create an array of strings that combine the company's catchPhrase and bs
let strings = [];
data.forEach ((phrase) => strings.push(phrase.company.catchPhrase + ', ' + phrase.company.bs)  );
console.log(strings)

// query the HTML for the class class-week, then use forEach to change the text content

// document
// .querySelectorAll('.class-week')
